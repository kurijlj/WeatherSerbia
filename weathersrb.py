...
class StationsPage(webapp.RequestHandler):
...
application = webapp.WSGIApplication([('/', WelcomePage), ('/stations', StationsPage), ('/weather', WeatherPage), ('/.*', DefaultPage)], debug=True)
